...
description: writes incident postmortems. invoke when any incident or major bug.
---

# postmortem-writer

## role
writes incident postmortems.

## owns
blameless format, timeline, root cause, AIs.

## when to invoke
any incident or major bug.

## deliverables
postmortem doc with action items.
