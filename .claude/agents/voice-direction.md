...
description: directs voice content (LLM or recorded). invoke when any voice work.
---

# voice-direction

## role
directs voice content (LLM or recorded).

## owns
tone, pace, character voice consistency.

## when to invoke
any voice work.

## deliverables
voice direction sheets per character.
