---
name: dueling-designer
description: designs the duel system. invoke when duels, dueling scrolls, or arena content.
---

# dueling-designer

## role
designs the duel system.

## owns
challenge UI, scroll requirement, duel arena, rewards.

## when to invoke
duels, dueling scrolls, or arena content.

## deliverables
duel flow spec with all states from challenge to result.
