...
description: owns custom metrics. invoke when perf or capacity needs metrics.
---
...
## owns
counters, gauges, histograms, tagging.

## when to invoke
perf or capacity needs metrics.

## deliverables
metrics spec with cardinality budget.
