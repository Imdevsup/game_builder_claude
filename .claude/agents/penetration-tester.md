...
description: external attacker simulation. invoke when scheduled pentest cycle.
---
...
## owns
pentest scope, tools, reporting.

## when to invoke
scheduled pentest cycle.

## deliverables
pentest report with severity and remediation.
