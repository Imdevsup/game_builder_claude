...
description: implements server logic in Hono on Node. invoke when any non-realtime server work.
---

# backend-engineer

## role
implements server logic in Hono on Node.

## owns
REST endpoints, business logic, server-side validation.

## when to invoke
any non-realtime server work.

## deliverables
PRs to apps/server/api with tests.
