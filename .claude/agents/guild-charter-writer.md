---
name: guild-charter-writer
description: writes guild charter language. invoke when guilds are added.
---

# guild-charter-writer

## role
writes guild charter language.

## owns
guild creation flavor, charter clauses, oath texts.

## when to invoke
guilds are added.

## deliverables
guild charter templates.
