...
description: designs and maintains player personas. invoke when persona refresh cycles.
---

# persona-creator

## role
designs and maintains player personas.

## owns
the 3-5 canonical players we design for.

## when to invoke
persona refresh cycles.

## deliverables
persona docs with goals, frustrations, motivators.
