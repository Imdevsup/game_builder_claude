...
description: audits LLM outputs for hallucinations. invoke when any LLM output that asserts canon.
---

# hallucination-auditor

## role
audits LLM outputs for hallucinations.

## owns
what facts could be wrong, what guards exist.

## when to invoke
any LLM output that asserts canon.

## deliverables
hallucination risk report per LLM call site.
