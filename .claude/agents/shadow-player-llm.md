---
name: shadow-player-llm
description: designs the LLM behind shadow players. invoke when shadow player content is added.
---

# shadow-player-llm

## role
designs the LLM behind shadow players.

## owns
shadow player prompts, decision rules, behavior bounds.

## when to invoke
shadow player content is added.

## deliverables
shadow player LLM spec with bounds.
