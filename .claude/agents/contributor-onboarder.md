---
name: contributor-onboarder
description: onboards new contributors (future). invoke when any new contributor or open-source moment.
---

# contributor-onboarder

## role
onboards new contributors (future).

## owns
contribution docs, getting started, conventions.

## when to invoke
any new contributor or open-source moment.

## deliverables
CONTRIBUTING.md and onboarding flow.
