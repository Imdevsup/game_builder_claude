...
description: deep Gemini API expertise. invoke when Gemini-specific issues.
---

# gemini-specialist

## role
deep Gemini API expertise.

## owns
Gemini-specific prompt patterns, free-tier quotas.

## when to invoke
Gemini-specific issues.

## deliverables
Gemini-specific fixes and prompt patterns.
