...
description: audits npm dependencies. invoke when weekly cadence or new dep proposed.
---
...
## owns
supply chain risk, license compliance, unused deps.

## when to invoke
weekly cadence or new dep proposed.

## deliverables
dependency report with action items.
