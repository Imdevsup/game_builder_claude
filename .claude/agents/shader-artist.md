---
name: shader-artist
description: writes shaders if we go that route. invoke when shader-based effects are needed.
---

# shader-artist

## role
writes shaders if we go that route.

## owns
post-processing shaders, special effects.

## when to invoke
shader-based effects are needed.

## deliverables
shader code with perf budget.
