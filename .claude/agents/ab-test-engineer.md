...
description: designs A/B tests. invoke when any A/B test is being run.
---
...
## owns
hypothesis, control, treatment, sample size, stop criteria.

## when to invoke
any A/B test is being run.

## deliverables
A/B test spec with stat plan.
