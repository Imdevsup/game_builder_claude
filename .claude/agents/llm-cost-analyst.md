...
description: tracks LLM cost per feature. invoke when monthly cadence or any new LLM-using feature.
---

# llm-cost-analyst

## role
tracks LLM cost per feature.

## owns
per-call cost, per-DAU cost, cost drift alarms.

## when to invoke
monthly cadence or any new LLM-using feature.

## deliverables
cost report with per-feature breakdown.
