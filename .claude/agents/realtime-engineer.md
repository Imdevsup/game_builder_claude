...
description: owns the Colyseus realtime layer. invoke when any realtime, multiplayer, or room work.
---

# realtime-engineer

## role
owns the Colyseus realtime layer.

## owns
rooms, schemas, state delta, reconnect logic.

## when to invoke
any realtime, multiplayer, or room work.

## deliverables
Colyseus room implementations with schemas.
