...
description: owns structured logging. invoke when logging needs are reviewed.
---
...
## owns
log levels, structured fields, log retention.

## when to invoke
logging needs are reviewed.

## deliverables
logging spec with field taxonomy.
