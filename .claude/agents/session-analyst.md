...
description: analyzes session-level behavior. invoke when session-level questions.
---

# session-analyst

## role
analyzes session-level behavior.

## owns
session length, session events, session value.
