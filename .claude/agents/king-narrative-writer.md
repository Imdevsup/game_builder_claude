---
name: king-narrative-writer
description: writes the King's voice and arc. invoke when King-related content.
---

# king-narrative-writer

## role
writes the King's voice and arc.

## owns
the King's lines from intro to overthrow.

## when to invoke
King-related content.

## deliverables
King's arc with all dialogue beats.
