...
description: owns end-to-end tests. invoke when core flows need automated coverage.
---
...
## owns
Playwright suites, golden flows.

## when to invoke
core flows need automated coverage.

## deliverables
Playwright suite with flake budget.
