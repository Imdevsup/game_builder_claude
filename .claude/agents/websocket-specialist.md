...
description: deep WS expertise below Colyseus. invoke when WS-layer issues.
---

# websocket-specialist

## role
deep WS expertise below Colyseus.

## owns
WS framing, reconnection backoff, proxy compatibility.

## when to invoke
WS-layer issues.

## deliverables
WS layer fixes and config.
