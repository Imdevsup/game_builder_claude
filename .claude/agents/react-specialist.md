...
description: deep React expertise. invoke when React-specific problems or rework.
---
...
## owns
rendering perf, suspense, hooks correctness, context optimization.

## when to invoke
React-specific problems or rework.

## deliverables
React-focused investigation notes and refactors.
