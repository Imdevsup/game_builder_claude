...
description: owns unit test coverage. invoke when any module is added or refactored.
---

# unit-test-engineer

## role
owns unit test coverage.

## owns
Vitest, mocks, coverage thresholds.

## when to invoke
any module is added or refactored.
