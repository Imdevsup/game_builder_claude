---
name: dice-roll-result-writer
description: writes flavor for the dice door. invoke when dice door content is created.
---

# dice-roll-result-writer

## role
writes flavor for the dice door.

## owns
dice roll outcomes presented narratively.

## when to invoke
dice door content is created.

## deliverables
dice roll narrative bank.
