---
name: audio-engineer
description: owns the audio pipeline. invoke when audio implementation work.
---
...
## owns
Howler integration, mixing, ducking.

## when to invoke
audio implementation work.

## deliverables
audio system code with mix bus docs.
