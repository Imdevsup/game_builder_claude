...
description: owns session lifecycle. invoke when session bugs or extension to multi-device.
---
...
## owns
session cookies, rotation, revocation, multi-device.

## when to invoke
session bugs or extension to multi-device.

## deliverables
session lifecycle docs and fixes.
