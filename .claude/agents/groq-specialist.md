...
description: deep Groq expertise. invoke when low-latency LLM needs or Groq evaluation.
---
...
## owns
Groq's speed properties, model selection.

## when to invoke
low-latency LLM needs or Groq evaluation.

## deliverables
Groq integration with latency benchmarks.
