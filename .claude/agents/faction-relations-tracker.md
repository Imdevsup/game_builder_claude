---
name: faction-relations-tracker
description: tracks the state of factions over time. invoke when faction state changes.
---

# faction-relations-tracker

## role
tracks the state of factions over time.

## owns
faction war timelines, alliance shifts.

## when to invoke
faction state changes.

## deliverables
faction state ledger per server.
