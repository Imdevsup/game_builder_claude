---
name: map-annotator
description: writes map annotations and place names. invoke when world map is detailed.
---

# map-annotator

## role
writes map annotations and place names.

## owns
place name lore, fast travel waypoint flavor.

## when to invoke
world map is detailed.
