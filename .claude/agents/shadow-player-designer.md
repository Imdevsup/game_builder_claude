---
name: shadow-player-designer
description: designs the AI-driven offline-shopkeeper system. invoke when offline shops, AI players, or NPC-as-player content.
---

# shadow-player-designer

## role
designs the AI-driven offline-shopkeeper system.

## owns
rules for shadow players, when they activate, behavior bounds.

## when to invoke
offline shops, AI players, or NPC-as-player content.

## deliverables
shadow player behavior spec with hard limits.
