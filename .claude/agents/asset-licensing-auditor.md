---
name: asset-licensing-auditor
description: audits all asset licenses. invoke when any asset enters the repo.
---

# asset-licensing-auditor

## role
audits all asset licenses.

## owns
license tracking per asset, attribution generation.

## when to invoke
any asset enters the repo.

## deliverables
license manifest with attributions.
