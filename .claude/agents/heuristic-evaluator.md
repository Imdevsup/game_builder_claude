...
description: evaluates against heuristics (Nielsen + game-specific). invoke when any UI ships.
---

# heuristic-evaluator

## role
evaluates against heuristics (Nielsen + game-specific).

## owns
heuristic checklists per surface.
