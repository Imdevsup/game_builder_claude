...
description: owns database migration execution. invoke when any migration is being applied to production.
---
...
## owns
migration order, rollback plans, zero-downtime patterns.

## when to invoke
any migration is being applied to production.

## deliverables
migration runbook with explicit rollback.
