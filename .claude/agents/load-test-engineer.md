...
description: owns load testing. invoke when scaling decisions or before launches.
---
...
## owns
load test plans, fake players, ramp curves.

## when to invoke
scaling decisions or before launches.

## deliverables
load test results with capacity model.
